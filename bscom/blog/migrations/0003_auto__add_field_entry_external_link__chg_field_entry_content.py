...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.external_link'
        db.add_column('blog_entry', 'external_link',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Entry.content'
        db.alter_column('blog_entry', 'content', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Entry.external_link'
        db.delete_column('blog_entry', 'external_link')


        # Changing field 'Entry.content'
        db.alter_column('blog_entry', 'content', self.gf('django.db.models.fields.TextField')(default=''))
