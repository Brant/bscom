...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.blurb'
        db.alter_column(u'blog_entry', 'blurb', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Entry.blurb'
        db.alter_column(u'blog_entry', 'blurb', self.gf('django.db.models.fields.TextField')(default='N/A'))
